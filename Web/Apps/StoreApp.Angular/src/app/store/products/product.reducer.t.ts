...
export const productReducer = createReducer(
  ...
  on(ProductActions.loadProductSuccess, (state, product) => ({ ...state, currentProduct: product, loading: false })),
  on(ProductActions.loadProductFailure, (state, error) => ({ ...state, loading: false, error })),

  // Add product
  on(ProductActions.addProduct, (state) => ({ ...state, loading: true, error: null })),
  on(ProductActions.addProductSuccess, (state) => ({ ...state, loading: false })),
  ...
  on(ProductActions.updateProductSuccess, (state) => ({ ...state, loading: false })),
  ...
  on(ProductActions.deleteProductSuccess, (state) => ({ ...state, loading: false })),
  on(ProductActions.deleteProductFailure, (state, error) => ({ ...state, loading: false, error })),

  on(ProductActions.setCurrentPage, (state, { page }) => ({ ...state, currentPage: page })),
  on(ProductActions.setPageSize, (state, { pageSize }) => ({ ...state, pageSize })),
);
