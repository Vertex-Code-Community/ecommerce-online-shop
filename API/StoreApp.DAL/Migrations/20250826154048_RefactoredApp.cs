...
{
    /// <inheritdoc />
    public partial class RefactoredApp : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Products_Discount", "[Discount] >= 0 AND [Discount] <= 1");
                    table.CheckConstraint("CK_Products_Price", "[Price] >= 0");
                    table.CheckConstraint("CK_Products_UnitsInStock", "[UnitsInStock] >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_ProductDetails_UnitsInStock", "[UnitsInStock] >= 0");
                    table.ForeignKey(
                        name: "FK_ProductDetails_ProductImages_ProductImagesId",
            ...
            migrationBuilder.CreateIndex(
                name: "UX_CartItems_User_ProductDetail",
                table: "CartItems",
                columns: new[] { "UserId", "ProductDetailId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ProductDetails_ProductImagesId",
                table: "ProductDetails",
                column: "ProductImagesId");

            migrationBuilder.CreateIndex(
                name: "UX_ProductDetails_Product_Color_Size",
                table: "ProductDetails",
                columns: new[] { "ProductId", "ColorName", "SizeName" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ProductImages_ProductId_ColorHex",
                table: "ProductImages",
                columns: new[] { "ProductId", "ColorHex" },
                unique: true);
